...
public class ThinkingHatItem extends BaseOutfitItem {
	...
	/**
	 * 创建思考帽物品实例，如果加载了 Curios 模组则创建 Curios 版本喵~
	 *
	 * @param variant 颜色变体喵~
	 * @return 思考帽物品实例喵~
	 */
	public static ThinkingHatItem of(Variant variant) {
		if(ModList.get().isLoaded("curios")) {
			return VWCuriosFactory.thinkingHat(variant, OUTFIT_PROPERTIES);
		}
		return new ThinkingHatItem(variant, OUTFIT_PROPERTIES);
	}
